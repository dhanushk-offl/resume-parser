...
```typescript
import { parseResume, analyzeResume, suggestImprovements } from "resume-parser";
...
```typescript
import { parseResume, analyzeResume } from "resume-parser";
import fs from "fs";
...
```typescript
import { fullPipeline } from "resume-parser";
